...
#endif
{
  ...
  {
  {
    ...
    if ( (LA(1)==PROCEDURE) ) {
      ...
      cap_procedure(zzSTR); zzlink(_root, &_sibling, &_tail);
      dec_vars(zzSTR); zzlink(_root, &_sibling, &_tail);
      l_dec_blocs(zzSTR); zzlink(_root, &_sibling, &_tail);
      l_instrs(zzSTR); zzlink(_root, &_sibling, &_tail);
      ...
      if ( (LA(1)==FUNCTION) ) {
        ...
        cap_function(zzSTR); zzlink(_root, &_sibling, &_tail);
        dec_vars(zzSTR); zzlink(_root, &_sibling, &_tail);
        l_dec_blocs(zzSTR); zzlink(_root, &_sibling, &_tail);
        l_instrs(zzSTR); zzlink(_root, &_sibling, &_tail);
...
#endif
{
  ...
  {
  zzmatch(IDENT); zzsubroot(_root, &_sibling, &_tail); zzCONSUME;
  cjt_parametres(zzSTR); zzlink(_root, &_sibling, &_tail);
  zzEXIT(zztasp1);
  return;
fail:
  zzEXIT(zztasp1);
...
void
#ifdef __USE_PROTOS
cjt_parametres(AST**_root)
#else
cjt_parametres(_root)
AST **_root;
#endif
{
  zzRULE;
  ...
  zzmatch(OPENPAR);  zzCONSUME;
  {
    ...
    {
    if ( (setwd2[LA(1)]&0x4) ) {
      parametre(zzSTR); zzlink(_root, &_sibling, &_tail);
      {
        zzBLOCK(zztasp3);
        zzMake0;
        {
...
#endif
{
  ...
  {
  if ( (LA(1)==VAR) ) {
    zzmatch(VAR); zzsubroot(_root, &_sibling, &_tail); zzCONSUME;
    zzmatch(IDENT); zzsubchild(_root, &_sibling, &_tail); zzCONSUME;
    {
      zzBLOCK(zztasp2);
      zzMake0;
      ...
      }
      {
        ...
        if ( (LA(1)==ASIG) ) {
          ...
          if ( (LA(1)==OPENPAR) ) {
            ...
            params(zzSTR); zzlink(_root, &_sibling, &_tail);
...
#endif
{
  ...
  zzMake0;
  {
  comparison_exp(zzSTR); zzlink(_root, &_sibling, &_tail);
  {
    zzBLOCK(zztasp2);
    zzMake0;
    {
...
void
#ifdef __USE_PROTOS
comparison_exp(AST**_root)
#else
comparison_exp(_root)
AST **_root;
#endif
{
  zzRULE;
        ...
        if ( (LA(1)==INTCONST) ) {
          ...
          if ( (LA(1)==CERT) ) {
            ...
            if ( (LA(1)==FALS) ) {
              ...
              if ( (LA(1)==STRINGEXP) ) {
                zzmatch(STRINGEXP); zzsubchild(_root, &_sibling, &_tail); zzCONSUME;
              }
